...
submit_spark_job = SparkKubernetesOperator(
    ...
    namespace='airflow',  # Your Kubernetes namespace
    application_file='spark-pi.yaml',  # Spark application YAML file
    kubernetes_conn_id='k8s_default',  # Kubernetes connection ID in Airflow
    do_xcom_push=True,
    dag=dag,
)
